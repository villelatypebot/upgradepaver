            ...
            <div className="mx-2 flex flex-wrap gap-2">
                {deliveryZones.map(zone => (
                    <button
                        ...
                        className={cn(
                            "flex-1 min-w-[140px] flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl border-2 text-sm font-medium transition-all",
            ...
            <ChatMessage type="bot">
                ...
                <div className="bg-muted/50 rounded-lg p-3 space-y-2 text-sm">
                    <div className="flex justify-between">
                        ...
                        <span className="font-medium">{quote.product.name} - {quote.variant.name}</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-muted-foreground">Area</span>
                        <span>{quote.areaSqft} sq ft (+{quote.wastePercentage}% waste = {quote.areaWithWaste} sq ft)</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-muted-foreground">Coverage per pallet</span>
